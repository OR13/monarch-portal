    ...
    return (
                ...
                <div className='col-sm-2 branding'>
                  <div className='row'>
                    <div className='navbar-header'>
                      ...
                      <img src={require('../../img/logo.png')} alt='{i18n.t("Monarch Portal")}' className='img-responsive logo' />
                        <span className='sr-only'>{i18n.t('Monarch Portal')}</span>
                      </Link>
                    </div>
                  </div>
                </div>
      ...
      onClick={() => this.context.router.push(`/objects/${parse(this.refs.dagPath.val()).urlify()}`)}>
                  ...
                  <ul className='nav navbar-nav navbar-right collapse navbar-collapse'>
                    <li>
                      <a href='http://portal.transmute.industries' target='_blank' data-toggle='tooltip' data-placement='bottom' title={i18n.t('Live Demo')}>
                        <img src={require('../../img/help.png')} alt='Help' className='img-responsive icon' />
                        <span className='sr-only'>{i18n.t('Live Demo')}</span>
                      </a>
                    </li>
                    <li>
                      <a href='https://github.com/transmute-industries/monarch-portal' target='_blank' data-toggle='tooltip' data-placement='bottom' title={i18n.t('Github Repository')}>
                        <img src={require('../../img/git.png')} alt='Github' className='img-responsive icon' />
                        <span className='sr-only'>{i18n.t('Github')}</span>
                      </a>
                    </li>
                    <li>
                      <a href='https://github.com/transmute-industries/monarch-portal/issues/new' target='_blank' data-toggle='tooltip' data-placement='bottom' title={i18n.t('Report Bugs')}>
